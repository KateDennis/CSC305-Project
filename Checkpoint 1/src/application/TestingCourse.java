...
class TestingCourse {
	...
	void testRandomObjects() {
		...
		Course courseOne = new Course("CSC-201-02", "Intro to Computer Science", "OLIN", "307", "Tauheed Khan Mohd",
				"10:30AM", "11:45AM", "M W F");
	...
	void testACopy() {
		...
		Course courseTwo = new Course("MUSC-211L-01", "Muscianship III Lab", "BERG", "POTTERH", "Margaret J Ellis",
				"8:20AM", "9:10AM", "Tu Th");
	...
	void testInputVariety() {
		...
		Course courseOne = new Course("MUSC-211L-01", "Muscianship III Lab", "BERG", "POTTERH", "Margaret J Ellis",
				"8:20AM", "9:10AM", "Tu Th");

		Course courseTwo = new Course("  MUSC-211L-01", "Muscianship  III Lab", "BERG ", "POTTERH  ",
				"Margaret   J Ellis", "8:20AM  ", "9:10AM", "Tu    Th ");
	...
	void testTwoCourses() {
		...
		Course courseOne = new Course("MUEN-209-NC", "Symphonic Band", "BERG", "ER", "James M Lambrecht", "4:15PM",
				"5:30PM", "Tu Th");

		Course courseTwo = new Course("CSC-201-02", "Intro to Computer Science", "OLIN", "307", "Tauheed Khan Mohd",
				"10:30AM", "11:45AM", "M W F");
	...
	void testingBefore() {
		...
		Course courseTwo = new Course("MUEN-209-NC", "Symphonic Band", "BERG", "ER", "James M Lambrecht", "4:15PM",
				"5:30PM", "Tu Th");
	...
	void testingWithin() {
		...
		Course courseOne = new Course("MUSC-211L-01", "Muscianship III Lab", "BERG", "POTTERH", "Margaret J Ellis",
				"8:30AM", "11:30AM", "M Tu W Th F");

		Course courseTwo = new Course("MUEN-209-NC", "Symphonic Band", "BERG", "ER", "James M Lambrecht", "10:30AM",
				"11:25", "Tu W Th F");
